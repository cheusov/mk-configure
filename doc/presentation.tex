...
\begin{frame}
  ...
  \begin{block}{Design principles and goals}
    ...
    \item Basic principles are similar to the
      \h{traditional \mbox{bsd.*.mk} files}.
...
\begin{frame}[fragile,t]
  ...
  \item MK-C has no site yet (I'm thinking of ikiwiki).
  \item sf.net provides two mailing lists:\\
    \h{mk-configure-help} and \h{mk-configure-discuss}.
  \item MK-C is not feature-rich yet, TODO file
    in the distribution is full of tasks.
  \end{itemize}
  \end{block}
\end{frame}
