...
.if ${HAVE_FUNCLIB.err:U1} && ${HAVE_FUNCLIB.errx:U1} && \
    ${HAVE_FUNCLIB.verr:U1} && ${HAVE_FUNCLIB.verrx:U1} && \
    ${HAVE_FUNC3.err.err_h:U1} && ${HAVE_FUNC3.errx.err_h:U1} && \
    ${HAVE_FUNC3.verr.err_h:U1} && ${HAVE_FUNC3.verrx.err_h:U1}
